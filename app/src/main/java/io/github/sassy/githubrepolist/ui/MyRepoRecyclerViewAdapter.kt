...
import io.github.sassy.githubrepolist.ui.dummy.DummyContent.DummyItem
 ...
 */
class MyRepoRecyclerViewAdapter(
    private val mValues: List<String>,
    private val mListener: OnListFragmentInteractionListener?
) : RecyclerView.Adapter<MyRepoRecyclerViewAdapter.ViewHolder>() {
